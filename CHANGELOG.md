...
### Enhancements
- Added support for Ruby 3.2. Previously, only Ruby 2.7 and earlier were supported.

### Bug Fixes
- Fix Ruby 2.7+ numbered parameter warnings by removing dependency on mime-types 2.x (via docverter removal)
